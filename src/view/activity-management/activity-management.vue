      ...
      <div class="everyday-assess-content">
        <div class="everyday-assess-left">
          ...
          <el-menu :default-active="pathURL" class="el-menu-vertical-demo" unique-opened active-text-color="#0A72E6" router>
            <el-menu-item index="/activityManagement/questionnaireSurvey?type=1">问卷调查</el-menu-item>
            <el-menu-item index="/activityManagement/platformActivity?type=2">平台活动</el-menu-item>
          </el-menu>
        </div>
...
export default {
  ...
  methods: {
    ...
    getType () {
      ...
      if (this.type === 1) {
        this.pathURL = '/activityManagement/questionnaireSurvey?type=1'
      } else if (this.type === 2) {
        this.pathURL = '/activityManagement/platformActivity?type=2'
      }
    },
    // 滚动条置顶
    scrollTop () {
