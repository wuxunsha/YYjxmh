    ...
    getType () {
      ...
      if (activeIndex === 0) {
        this.breadcrumbList = [
          {
            content: '绩效资讯',
            breadcrumbUrl: '/performanceInformation/workDynamic?navIndex=1'
          },
          {
            content: '最新资讯',
            breadcrumbUrl: '/performanceInformation/workDynamic?navIndex=1'
        ...
        this.breadcrumbList = [
          {
            content: '绩效资讯',
            breadcrumbUrl: '/performanceInformation/fileAnnouncement?navIndex=2'
          },
          {
            content: '文件公告',
            breadcrumbUrl: '/performanceInformation/fileAnnouncement?navIndex=2'
        ...
        this.breadcrumbList = [
          {
            content: '绩效资讯',
            breadcrumbUrl: '/performanceInformation/mediaFocus?navIndex=3'
          },
          {
            content: '媒体聚焦',
            breadcrumbUrl: '/performanceInformation/mediaFocus?navIndex=3'
