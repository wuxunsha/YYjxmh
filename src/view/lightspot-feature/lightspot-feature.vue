      ...
      <div class="crumbs-nav">
        <div>
          <el-breadcrumb separator-class="el-icon-arrow-right">
              ...
              <el-breadcrumb-item>亮点特色</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </div>
        ...
        <div class="everyday-assess-left">
          <div class="everyday-assess-title">
            <div class="everyday-assess-title-content">
              <span class="iconfont iconchuangxin"></span>
              <span>
                <span>亮点特色</span>
          ...
          <el-menu :default-active="pathURL" class="el-menu-vertical-demo" unique-opened active-text-color="#0A72E6" router>
            <el-menu-item index="/lightspotFeature/cityUnit?navIndex=1">市直单位亮点特色</el-menu-item>
            <el-menu-item index="/lightspotFeature/region?navIndex=2">区县(市)亮点特色</el-menu-item>
          </el-menu>
        </div>
...
export default {
  ...
  methods: {
    ...
    getType () {
      ...
      if (this.navIndex === 1) {
        this.pathURL = '/lightspotFeature/cityUnit?navIndex=1'
      } else if (this.navIndex === 2) {
        this.pathURL = '/lightspotFeature/region?navIndex=2'
      }
    },
    // 滚动条置顶
    scrollTop () {
