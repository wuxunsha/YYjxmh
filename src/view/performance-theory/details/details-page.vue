...
export default {
  ...
  methods: {
    ...
    getType () {
      ...
      let activeIndex = Number(this.$route.query.activeIndex)
      if (activeIndex === 1) {
        this.breadcrumbList = [
          {
            content: '绩效理论',
            breadcrumbUrl: '/performanceTheory/theoryStudy?navIndex=1'
          },
          {
            content: '理论研究',
            breadcrumbUrl: '/performanceTheory/theoryStudy?navIndex=1'
        ...
        this.breadcrumbList = [
          {
            content: '绩效理论',
            breadcrumbUrl: '/performanceTheory/adviceFromOthers?navIndex=2'
          },
          {
            content: '他山之石',
            breadcrumbUrl: '/performanceTheory/adviceFromOthers?navIndex=2'
        ...
        this.breadcrumbList = [
          {
            content: '绩效理论',
            breadcrumbUrl: '/performanceTheory/exchangeStudy?navIndex=3'
          },
          {
            content: '学习交流',
            breadcrumbUrl: '/performanceTheory/exchangeStudy?navIndex=3'
        ...
        this.breadcrumbList = [
          {
            content: '绩效理论',
            breadcrumbUrl: '/performanceTheory/yyPractice?navIndex=4'
          },
          {
            content: '益阳实践',
            breadcrumbUrl: '/performanceTheory/yyPractice?navIndex=4'
