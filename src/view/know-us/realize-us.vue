      ...
      <div class="everyday-assess-content">
        <div class="everyday-assess-left">
          ...
          <el-menu :default-active="pathURL" class="el-menu-vertical-demo" unique-opened active-text-color="#0A72E6" router>
            <el-menu-item index="orgIntroduce?type=1">机构介绍</el-menu-item>
            <el-menu-item index="announcement?type=2">公告公示</el-menu-item>
          </el-menu>
        </div>
...
export default {
  ...
  methods: {
    ...
    getType () {
      ...
      if (this.type === 1) {
        this.pathURL = 'orgIntroduce?type=1'
      } else if (this.type === 2) {
        this.pathURL = 'announcement?type=2'
      }
    },
    // 滚动条置顶
    scrollTop () {
